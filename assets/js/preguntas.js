...
$("#tipo_pregunta").replaceWith("\
                        <div class='col-lg-12' id='tipo_pregunta'>\n\
                            ...
                            <div class='col-lg-11' style='text-align:center;justify-content:center;'>\n\
                                <div class='col-lg-6'>\n\
...
function cambio(x) {
        ...
        $("#tipo_pregunta").replaceWith("\
                        ...
                        \n\<textarea class='form-control' id='enunciado' rows='4' style='resize: none' name='enunciado' required></textarea><br/><br/>\n\
                            ...
                            <div id='segmentos' >\n\
                                <div class='col-lg-12' style='float:left;padding-top:10px;padding-bottom:10px;'>\n\
                ...
                $('#agregar').click(function () {
        i++;
                $('#segmentos').append('<div id="piece1' + i + '" class="col-lg-3" style="padding-right: 0px;padding-left: 0px;padding-top:5px">\n\
                                                        <div class="col-lg-10 col-sm-5 col-md-5 col-xs-10" style="padding-right: 0px;padding-left: 0px;">\n\
...
\n\                                                         <input type="hidden" value='+i+' name="ct"/>\n\
        ...
        j++;
                $('#segmentos').append('<div id="piece2' + j + '" class="col-lg-3" style="padding-right: 0px;padding-left: 0px;padding-top:5px">\n\
                                                        <div class="col-lg-10 col-sm-5 col-md-5 col-xs-10" style="padding-right: 0px;padding-left: 0px;">\n\
