...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(190, -10, utf8_decode('Evaluación: ' . $descripcion['descripcion'] . " (Solucionario)"), 0, 0, 'C');
        // Salto de línea
        $this->Ln(3);
    }
        ...
        if (isset($_POST['codexamen'])) {
            ...
            foreach ($preguntas as $preg) {
                ...
                if ($preg['tipo'] == 'UNIR') {
                    ...
                    $this->MultiCell(190, 5, utf8_decode("      RESPUESTA CORRECTA: ".$f), 0, '', $fill);
                    ...
                    Conexion::cerrar_conexion();
                    $this->MultiCell(190, 5, utf8_decode("      RESPUESTA CORRECTA: " . $respuesta['respuesta']), 0, '', $fill);
                    ...
                    Conexion::cerrar_conexion();
                    shuffle($respuestas);
                    $this->MultiCell(190, 5, utf8_decode("      RESPUESTA CORRECTA: "), 0, '', $fill);
                    foreach ($respuestas as $respuesta) {
                        if ($respuesta['correcta'] == 'SI') {
                            $this->SetFont('Times', 'U', 12);
                            $this->MultiCell(190, 5, utf8_decode("      " . $respuesta['respuesta']), 0, 'U', $fill);
                        } else {
                            $this->SetFont('Times', '', 12);
