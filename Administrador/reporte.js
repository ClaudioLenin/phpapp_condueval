$(document).ready(function () {
    ...
    function cargarPeriodo1() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#periodo1').html(template);
            }
        });
    }
    cargarPeriodo2();
    function cargarPeriodo2() {
        console.log("Estoy en periodo");
        $.ajax({
            url: 'Pregunta/periodo.php',
            type: 'POST',
            success: function (response) {
                ...
                $('#periodo2').html(template);
            }
        });
    }
    cargarPeriodo3();
    function cargarPeriodo3() {
        console.log("Estoy en periodo");
        $.ajax({
            url: 'Pregunta/periodo.php',
            type: 'POST',
            success: function (response) {
                ...
                $('#periodo3').html(template);
            }
        });
    }
    cargarPeriodo4();
    function cargarPeriodo4() {
        console.log("Estoy en periodo");
        $.ajax({
            url: 'Pregunta/periodo.php',
            type: 'POST',
            success: function (response) {
                ...
                $('#periodo4').html(template);
            }
        });
    }
    //CARGAR SECCION
    $('#periodo1').change(function () {
        var codperiodo = $("#periodo1 option:selected").val();
    ...
    $('#periodo4').change(function () {
        var codperiodo = $("#periodo4 option:selected").val();
        console.log(codperiodo);
        $.ajax({
            url: 'Pregunta/seccion.php',
            type: 'POST',
    ...
    $('#materia1').change(function () {
        ...
        mostrar_docente1(coddocentemateria);
        mostrarReporte1();
    });
    ...
    $('#materia3').change(function () {
        ...
        mostrar_docente2(coddocentemateriareporte3);
        mostrarReporte3();
    });
    $('#materia4').change(function () {
        var coddocentemateria = $("#materia4 option:selected").val();
        mostrar_docente4(coddocentemateria);
        $.ajax({
    ...
    //MOSTRAR DOCENTES
    function mostrar_docente1(coddocentemateria) {
        $.ajax({
            url: 'Reporte/mostrarDocente.php',
            type: 'POST',
            data: {coddocentemateria},
            success: function (response) {
                //console.log(response);
                ...
                let template = '';
                tasks.forEach(task => {
                    template += `<label>Docente: ${task.nompersona} ${task.apepersona}</label>`;
                })
                $('#docente1').html(template);
            }
        });
    }
    function mostrar_docente2(coddocentemateria) {
        $.ajax({
            url: 'Reporte/mostrarDocente.php',
            type: 'POST',
            data: {coddocentemateria},
            success: function (response) {
                ...
                $('#docente2').html(template);
            }
        });
    }
    function mostrar_docente4(coddocentemateria) {
        $.ajax({
            url: 'Reporte/mostrarDocente.php',
            type: 'POST',
            data: {coddocentemateria},
