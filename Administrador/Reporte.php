                                                    ...
                                                    <div class="col-sm-6">
                                                        <form>
                                                            <div style="padding-left: 10px;padding-right: 10px">
                                                                ...
                                                                <select id="periodo1" name="periodo1" class="form-control">
                                                                </select>
                                                            </div>
                                                        </form>
                                                    </div>
                                                ...
                                                <div class="row col-lg-12" style="padding-bottom: 30px">
                                                    <div class="col-sm-4">
                                                        <form>
                                                            <div style="padding-left: 10px;padding-right: 10px">
                                                                <label>Seleccionar Periodo</label>
                                                                <select id="periodo2" name="periodo2" class="form-control">
                                                                </select>
                                                            </div>
                                                        </form>
                                                    </div>
                                            ...
                                            <div class="card-body" id="contenido-3">
                                                <div class="row col-lg-12" style="padding-bottom: 30px">
                                                    <div class="col-sm-6">
                                                        <form>
                                                            <div style="padding-left: 10px;padding-right: 10px">
                                                                <label>Seleccionar Periodo</label>
                                                                <select id="periodo3" name="periodo3" class="form-control">
                                                                </select>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div style="padding-left: 10px;padding-right: 10px;padding-top: 20px" id="docente2">
                                                ...
                                                <div class="col-lg-12 descarga">
                                                    <form method="post" action="Reporte/reporte3.php" target="_blank">
                                                        ...
                                                        <input type="hidden" id="codpersona" name="codpersona" value="<?php echo $_SESSION['codpersona'] ?>">
                                                        <input class="btn btn-danger" type="submit" value="Imprimir" id="Imprimir">
                                                    </form>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row col-lg-12" style="padding-bottom: 30px">
                                                    <div class="col-sm-6">
                                                        <form>
                                                            <div style="padding-left: 10px;padding-right: 10px">
                                                                <label>Seleccionar Periodo</label>
                                                                <select id="periodo4" name="periodo4" class="form-control">
                                                                </select>
                                                            </div>
                                                        </form>
                                                    </div>
